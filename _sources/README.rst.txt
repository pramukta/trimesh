...
-  Import geometry files (i.e. BREP (.brep), STEP (.stp or .step), 'IGES
   (.igs or .iges), etc.) via Gmsh SDK
-  Import skin of 3D FE Models (i.e. Abaqus (*.inp), Nastran (*.bdf),
   etc.) via Gmsh SDK
-  Export meshes as binary STL, binary PLY, ASCII OFF, OBJ, GLTF/GLB
   2.0, COLLADA, etc.
-  Export mesh as FE Models (i.e. Abaqus (*.inp), Nastran (*.bdf), etc.)
   via Gmsh SDK
